...
For those without access to an *IEEE Transactions on Power Systems* subscription, a pre-publication manuscript of the paper is available [here](https://www.zotero.org/sfrank/  "Zotero | People - Stephen M. Frank").
